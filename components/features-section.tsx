...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-16 sm:py-24 bg-transparent relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 text-balance" style={{ fontFamily: '"Bebas Neue", "Arial Black", sans-serif' }}>{t.features.title}</h2>
          <p className="text-lg text-white/90 max-w-2xl mx-auto text-pretty">{t.features.subtitle}</p>
        </div>
